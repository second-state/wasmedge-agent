 ...
 *   forkserver  fork each kernel from the pre-imported template (WASMEDGE_AGENT_KERNEL_FORKSERVER=1)
 *
...
process.env.WASMEDGE_AGENT_KERNEL_FORKSERVER = mode === "forkserver" ? "1" : "0";
