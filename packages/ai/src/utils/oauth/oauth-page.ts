...
<body>
  <main>
    <div class="logo" aria-label="WasmEdge Agent">${WASMEDGE_BUTTERFLY_SVG}</div>
    <h1>${heading}</h1>
    <p>${message}</p>
...
export function oauthSuccessHtml(message: string): string {
	return renderPage({
		title: "WasmEdge Agent authentication successful",
...
export function oauthErrorHtml(message: string, details?: string): string {
	return renderPage({
		title: "WasmEdge Agent authentication failed",
