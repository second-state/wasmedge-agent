...
export function loadSkills(options: LoadSkillsOptions): LoadSkillsResult {
	...
	// Resolved once per call: both uses below need the same directory, and
	// getProjectConfigDir hits the filesystem to decide it.
	...
	if (includeDefaults) {
		...
		addSkills(loadSkillsFromDirInternal(resolve(projectConfigDir, "skills"), "project", true));
	}

	const userSkillsDir = join(resolvedAgentDir, "skills");
	const projectSkillsDir = resolve(projectConfigDir, "skills");
