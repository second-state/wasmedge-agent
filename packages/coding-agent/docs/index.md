# WasmEdge Agent Documentation

WasmEdge Agent is an RLM-native coding and research harness built around sandboxed Rust cells (WebAssembly on WasmEdge), recursive subagents, durable sessions, and a multi-process local runtime. It began as a hard fork of pi-mono, but WasmEdge Agent is now the product, CLI, install source, and development repository.
...
- [Using WasmEdge Agent](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask WasmEdge Agent to create them.
...
- [WasmEdge Agent packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed WasmEdge Agent in Node.js applications.
- [ACP mode](acp.md) - drive WasmEdge Agent from any Agent Client Protocol client.
