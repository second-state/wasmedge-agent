> WasmEdge Agent can create prompt templates. Ask it to build one for your workflow.
...
WasmEdge Agent loads prompt templates from:

- Global: `~/.wasmedge-agent/prompts/*.md`
- Project: `.wasmedge-agent/prompts/*.md`
